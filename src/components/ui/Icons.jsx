...
export const HeartIcon = ({ size = 24, filled = false }) => (
  <svg 
...
export const StarIcon = ({ size = 24, filled = false }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? '#FBBF24' : 'none'} stroke={filled ? '#FBBF24' : 'currentColor'} strokeWidth="2">
...
export const BellIcon = ({ size = 24, count = 0, className = '' }) => (
  <span style={{ position: 'relative', display: 'inline-flex', verticalAlign: 'middle' }}>
    <svg 
      className={`bell-icon ${count > 0 ? 'bell-icon--has-count ' : ''}${className}`}
      width={size} height={size} 
      viewBox="0 0 24 24" 
      fill="none" 
      stroke="currentColor" 
      ...
      strokeLinejoin="round"
    >
      <path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-5.5V11c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5.5l-2 2v1h16v-1l-2-2z" />
    </svg>
    {count > 0 && (
      <span key={count} className="bell-badge">{count > 99 ? '99+' : count}</span>
    )}
  </span>
);
...
export const MoreVerticalIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ShirtIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const HomeRoundIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
